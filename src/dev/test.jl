...
# ╔═╡ 647ae890-5705-45e8-ad1c-31af5d3933e5
using Combinatorics, LRUCache, LinearAlgebra, Test, Profile, ITensors, ITensorMPS

# ╔═╡ 9c3d47e9-b102-4d1b-8cff-e61889ff3afe
using Main.EDKit

# ╔═╡ 85252984-9c7e-11ef-128f-13abee4c5023
include("../EDKit.jl");
...
manifest_format = "2.0"
project_hash = "933ce20d3f4a011132f0f8fbbdda43dad53ea0d2"
...
[[deps.ITensors]]
deps = ["Adapt", "BitIntegers", "ChainRulesCore", "Compat", "Dictionaries", "DocStringExtensions", "Functors", "IsApprox", "LinearAlgebra", "NDTensors", "Pkg", "Printf", "Random", "Requires", "SerializedElementArrays", "SimpleTraits", "StaticArrays", "Strided", "TimerOutputs", "TupleTools", "Zeros"]
git-tree-sha1 = "5dbbb468f46a754061fc29ba9b2577ee6f630845"
...
git-tree-sha1 = "93f90f920922d2639f0be3ba406cb43b4163d2ed"
